...
// CRUD Routes
router.post("/", protect, restrictTo("admin"), createCase); // Admin dava oluşturabilir
router.get("/", protect, restrictTo("admin", "lawyer"), getAllCases); // Tüm davaları görüntüleyebilir
